...
CINEMATOGRAPHY = CrewSpec(
    ...
    lexicon={
        ...
        "运镜": ("固定", "推", "拉", "摇", "移", "跟", "升", "降", "环绕",
                "手持晃动", "变焦推拉"),
        "机位高度": ("低机位", "低于视平线", "平视", "高机位", "高于视平线",
                   "俯拍", "仰拍", "过肩", "主观视角"),
        # 方位原来只写在维度描述里，没进术语表 —— 于是「正面」这种
        # 完全合格的回答因为太短被判成缺失。术语表同时是验收白名单，
        # 维度里列举的选项必须在这里也有一份
        "机位方位": ("正面", "四分之三侧", "正侧", "背侧", "背面", "过肩反打"),
        "构图": ("居中", "三分线", "对称", "框中框", "前景遮挡", "留白"),
...
EDITING = CrewSpec(
    ...
    lexicon={
        ...
        "切点": ("切在动作中", "切在静止", "切在视线", "切在声音", "留白后切"),
        "节奏": ("比前镜快", "比前镜慢", "同速", "加速", "减速", "骤停"),
        "入点": ("动作起始", "静止起幅", "入画", "已在进行中"),
    },
)
