...
const MENU_I18N: Record<string, Record<string, string>> = {
  "zh-CN": {
    ...
    culture: "文化包 / 世界观",
    assets: "素材库",
    entityPromptLib: "素材提示词库",
    promptAssets: "素材 & 角色成长",
  ...
  "en-US": {
    ...
    entityPromptLib: "Entity Prompt Library",
    promptAssets: "Prompt Assets & Growth",
  ...
  "ja-JP": {
    ...
    culture: "文化パック / 世界観",
    assets: "アセットライブラリ",
    entityPromptLib: "素材プロンプトライブラリ",
    promptAssets: "素材 & キャラ成長",
  ...
  "es-ES": {
    ...
    entityPromptLib: "Biblioteca de Prompts",
  ...
  "ar-SA": {
    ...
    assets: "مكتبة الأصول",
    entityPromptLib: "مكتبة التوجيهات",
...
const menuOptions = computed<MenuOption[]>(() => [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "/studio/entity-prompt-library", label: t.value.entityPromptLib },
      { key: "/studio/prompt-assets", label: t.value.promptAssets },
