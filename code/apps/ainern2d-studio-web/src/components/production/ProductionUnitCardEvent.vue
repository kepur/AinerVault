<template>
  <NCard class="unit-card event-card" size="small" :title="unit.unit_ref_id">
    <NSpace align="center">
      <NText depth="3">Event Unit</NText>
    ...
    <NSpace>
      ...
      <NButton size="tiny" @click="emit('patch', unit.unit_id)">Patch</NButton>
