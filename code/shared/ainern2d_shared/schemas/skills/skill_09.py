...
class RenderState(str, Enum):
    ...
    AUDIO_FEATURES_AGGREGATING = "AUDIO_FEATURES_AGGREGATING"
    AGGREGATING_AUDIO = AUDIO_FEATURES_AGGREGATING
    AUDIO_FEATURES_READY = "AUDIO_FEATURES_READY"
    MOTION_SCORING = "MOTION_SCORING"
    SCORING_MOTION = MOTION_SCORING
    MOTION_SCORED = "MOTION_SCORED"
    STRATEGY_MAPPING = "STRATEGY_MAPPING"
    ASSIGNING_RENDER = STRATEGY_MAPPING
    STRATEGY_READY = "STRATEGY_READY"
    MICROSHOT_SPLITTING = "MICROSHOT_SPLITTING"
    SPLITTING_MICRO = MICROSHOT_SPLITTING
